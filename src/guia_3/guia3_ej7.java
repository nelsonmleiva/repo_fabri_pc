...
public class guia3_ej7 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (cadena.length() == 5 && cadena.substring(0,1).equals("X") && cadena.substring(0,4).equals("O")) {
        ...
        System.out.println("Lecturas correctas: " + contCorrecto);
        System.out.println("Lecturas incorrectas: " + contIncorrecto);
